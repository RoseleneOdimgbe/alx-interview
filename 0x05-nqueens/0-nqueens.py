...
def n_queens(n: int):
    ...
    def is_non_attack(board: list, row: int, col: int) -> bool:
        ...
        Args:
            board (list): This is the board to check
            row (int): This is the current row on the board
            col (int): This is the column of the board
    ...
    def insert_queen(board: list, row: int) -> None:
        ...
        Args:
            ...
            row (int): This is the current row in the board
        """
        if row == n:  # base case
